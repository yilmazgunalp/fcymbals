...
Rails.application.config.assets.precompile += %w( resets.css )
...
Rails.application.config.assets.precompile += %w( retailer.css )
Rails.application.config.assets.precompile += %w( form.css )
Rails.application.config.assets.precompile += %w( svg.css )
Rails.application.config.assets.precompile += %w( retailer.js )
