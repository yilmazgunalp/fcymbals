...
@options = {
	#eats too much memory so disabled it
...
def self.get_node_sets first_page
	...
	while !page.at_css("a#MainContent_pdlAllProducts_dlProductList_LinkButtonNext").nil?
		node_set = page.at_css("td#MainContent_pdlAllProducts_dlProductList_tdLinks").
		css("a[id^='MainContent_pdlAllProducts_dlProductList_LinkButton']")
		node_sets << node_set
